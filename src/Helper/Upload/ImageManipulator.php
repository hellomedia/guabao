...
class ImageManipulator
{
    ...
    public function resizeImage(Image $image, int $maxWidth = self::MAX_WIDTH, int $maxHeight = self::MAX_HEIGHT)
    {
        try {
            $imagick = new \Imagick();
    ...
    // public function resizeProfileImage(User $user, int $maxWidth = self::MAX_PROFILE_WIDTH, int $maxHeight = self::MAX_PROFILE_HEIGHT) 
    // {
    //     try {
    //         $imagick = new \Imagick();

    //         $imagick->readImage($user->getPictureInternalPath());
