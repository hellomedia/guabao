 ...
 */
final class Version20250508213117 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        SQL);
        $this->addSql(<<<'SQL'
            CREATE TABLE picture_picture_tag (picture_id INT NOT NULL, picture_tag_id INT NOT NULL, PRIMARY KEY(picture_id, picture_tag_id))
        SQL);
        $this->addSql(<<<'SQL'
            CREATE INDEX IDX_AD257153EE45BDBF ON picture_picture_tag (picture_id)
        SQL);
        $this->addSql(<<<'SQL'
            CREATE INDEX IDX_AD2571532B36D501 ON picture_picture_tag (picture_tag_id)
        SQL);
        $this->addSql(<<<'SQL'
            CREATE TABLE picture_tag (id INT GENERATED BY DEFAULT AS IDENTITY NOT NULL, name_fr VARCHAR(100) NOT NULL, name_en VARCHAR(100) NOT NULL, slug_fr VARCHAR(100) NOT NULL, slug_en VARCHAR(100) NOT NULL, description_fr TEXT DEFAULT NULL, description_en TEXT DEFAULT NULL, PRIMARY KEY(id))
        SQL);
        $this->addSql(<<<'SQL'
        ...
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE country ADD CONSTRAINT FK_5373C966BA6A01AB FOREIGN KEY (food_cover_id) REFERENCES picture (id) NOT DEFERRABLE INITIALLY IMMEDIATE
        SQL);
        $this->addSql(<<<'SQL'
        ...
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE picture ADD CONSTRAINT FK_16DB4F89639666D6 FOREIGN KEY (meal_id) REFERENCES meal (id) ON DELETE SET NULL NOT DEFERRABLE INITIALLY IMMEDIATE
        SQL);
        $this->addSql(<<<'SQL'
        ...
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE picture_picture_tag ADD CONSTRAINT FK_AD257153EE45BDBF FOREIGN KEY (picture_id) REFERENCES picture (id) ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE picture_picture_tag ADD CONSTRAINT FK_AD2571532B36D501 FOREIGN KEY (picture_tag_id) REFERENCES picture_tag (id) ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE
        SQL);
        $this->addSql(<<<'SQL'
    ...
    public function down(Schema $schema): void
    {
        ...
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE picture_picture_tag DROP CONSTRAINT FK_AD257153EE45BDBF
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE picture_picture_tag DROP CONSTRAINT FK_AD2571532B36D501
        SQL);
        $this->addSql(<<<'SQL'
        ...
        SQL);
        $this->addSql(<<<'SQL'
            DROP TABLE picture_picture_tag
        SQL);
        $this->addSql(<<<'SQL'
