 ...
 */
final class Version20250504224856 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        SQL);
        $this->addSql(<<<'SQL'
            CREATE TABLE picture (id INT GENERATED BY DEFAULT AS IDENTITY NOT NULL, file_path VARCHAR(255) NOT NULL, updated_at TIMESTAMP(0) WITHOUT TIME ZONE DEFAULT NULL, taken_at TIMESTAMP(0) WITH TIME ZONE DEFAULT NULL, highlight BOOLEAN DEFAULT NULL, cover BOOLEAN DEFAULT NULL, latitude DOUBLE PRECISION DEFAULT NULL, longitude DOUBLE PRECISION DEFAULT NULL, description_fr TEXT DEFAULT NULL, description_en TEXT DEFAULT NULL, food_item_id INT DEFAULT NULL, dish_id INT DEFAULT NULL, breakfast_id INT DEFAULT NULL, drink_id INT DEFAULT NULL, bakery_item_id INT DEFAULT NULL, dessert_id INT DEFAULT NULL, fruit_id INT DEFAULT NULL, trip_id INT DEFAULT NULL, place_id INT DEFAULT NULL, PRIMARY KEY(id))
        SQL);
        $this->addSql(<<<'SQL'
        ...
        SQL);
        $this->addSql(<<<'SQL'
            CREATE TABLE trip (id INT GENERATED BY DEFAULT AS IDENTITY NOT NULL, started_at DATE NOT NULL, ended_at DATE NOT NULL, name_fr VARCHAR(100) NOT NULL, name_en VARCHAR(100) NOT NULL, slug_fr VARCHAR(100) NOT NULL, slug_en VARCHAR(100) NOT NULL, description_fr TEXT DEFAULT NULL, description_en TEXT DEFAULT NULL, key VARCHAR(100) NOT NULL, PRIMARY KEY(id))
        SQL);
        $this->addSql(<<<'SQL'
